...
async def start(client: pr0fess0r_99, message: Message):
    ...
    button=[[
      InlineKeyboardButton("𝚃𝙰𝙼𝙸𝙻 𝙽𝙴𝚆 𝙼𝙾𝚅𝙸𝙴𝚂", url="https://t.me/+hSvUkQYM7BVjMmM1"),
      InlineKeyboardButton("𝚃𝙰𝙼𝙸𝙻 𝙼𝙾𝚅𝙸𝙴𝚂 𝙲𝙷𝙰𝚃", url="https://t.me/TamilanMoviesChat")
      ],[
      InlineKeyboardButton("𝚂𝚄𝙱𝚂𝙲𝚁𝙸𝙱𝙴", url=f"https://youtube.com/channel/UCOcoLecaMrqfU4m34y4hOIA")
      ]]
